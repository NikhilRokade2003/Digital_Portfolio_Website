...
const PortfolioView = () => {
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      // Use window.open to open the printable view in a new tab
      window.open(`/portfolio/print/${id}`, '_blank');
      
    } catch (error) {
      console.error('Error opening printable view:', error);
    } finally {
  ...
  return (
    <div className="min-h-screen bg-secondary-50">
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Portfolio owner banner/actions */}
        {isOwner && (
          <div className="mb-6 bg-primary-50 border-l-4 border-primary-500 p-4 rounded-r shadow-soft">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <p className="text-primary-800 font-medium">
                <span className="flex items-center">
                  ...
                  You're viewing your own portfolio
                </span>
              </p>
              <div className="flex flex-wrap gap-3">
                ...
                <Link 
                  to="/dashboard"
                  className="bg-secondary-100 hover:bg-secondary-200 border border-secondary-200 text-secondary-800 py-2 px-4 rounded-md font-medium transition-colors duration-300 shadow-soft flex items-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex justify-between items-start flex-wrap gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                <button 
                  ...
                  className={`bg-secondary-100 hover:bg-secondary-200 text-secondary-800 py-2 px-4 rounded-md font-medium transition-colors duration-300 shadow-soft ${isPdfLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
